...
projects.forEach(project => {
  ...
  div.innerHTML = `<a href="#" style="text-decoration:none; color:inherit; display:block;"><h3>${project.title}</h3><p>${project.desc}</p></a>`;
  div.querySelector('a').addEventListener('click', (e) => {
    e.preventDefault();
    const newWindow = window.open('', '_blank');
    newWindow.document.write('<html><head><title>Developer Message</title></head><body style="font-family: Arial, sans-serif; text-align: center; padding: 50px; background-color: #121212; color: #00ffe7;"><h1>Coming soon, working on it</h1><p>For further detail contact with developer</p></body></html>');
